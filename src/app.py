...
class App:
    ...
    def setup_ui(self):
        ...
        tk.Label(title_frame, text="📦 抛硬币工具", font=("Arial", 18, "bold"),
        ...
        # 根据工具名称添加特定功能
        if "timer" in "coin-flipper".lower() or "clock" in "coin-flipper".lower():
            self.setup_timer_ui(main)
        elif "random" in "coin-flipper".lower() or "dice" in "coin-flipper".lower() or "coin" in "coin-flipper".lower():
            self.setup_random_ui(main)
        elif "note" in "coin-flipper".lower() or "todo" in "coin-flipper".lower():
    ...
    def generate_random(self):
        if "dice" in "coin-flipper".lower():
            result = random.randint(1, 6)
            self.result_label.config(text=f"🎲 {result}")
        elif "coin" in "coin-flipper".lower():
